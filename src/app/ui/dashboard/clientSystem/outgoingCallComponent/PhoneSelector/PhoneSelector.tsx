...
export function PhoneSelector({
  ...
  return (
    <div
      className={`${className} relative flex flex-col !max-lg:w-full`}
      style={{
        width: `${width}vw`
      }}
      ref={ref}
    >
      <aside
        ...
        onClick={() => toggleOpen()}
      >
        <div className="w-[85%] h-[5.277778vh] pl-[0.2vw] pr-[0.2vw] overflow-clip max-lg:h-11">
          <div
        ...
        <aside
          ...
          ${isOpen ? 'block' : 'hidden'} max-lg:text-sm max-lg:max-h-48`}
          style={{
            ...(isOpen &&
