...
export async function POST(request: Request) {
  ...
  const businessSchema = z.object({
    ...
    storeName: z
      .string({ invalid_type_error: 'Please enter a valid value' })
      .min(1, 'Please enter a value'),
    image: z.any().refine((file: File) => !file || ACCEPTED_IMAGE_TYPES.includes(file.type), {
  ...
  // const adressFieldErrors = { state: undefined , stateId: undefined, city: undefined, street: undefined };
