...
export function Duplicates() {
  ...
  return (
    <section className="absolute top-0 right-0 left-0 bottom-0 bg-[#0000008A] h-full">
      ...
      <article className="relative w-[82.8125vw] h-fit mt-[135vh] ml-[8.4375vw] mb-[55.185185vh] bg-[#FFFFFF] rounded-[0.520833vw] pb-[3.055555vh]">
        ...
        {/* 1 */}
        <button className="w-[11.875vw] h-[5.462963vh] flex justify-center items-center mt-[2.777778vh] ml-[2.291667vw] text-[1.626852vh] font-semibold leading-[2.440741vh] rounded-[0.653646vw] border-[0.104167vw] border-[#00A78B] text-[#00A78B]">
          Find Duplicates
        </button>
        {/* 2 */}
        <aside className="mt-[5.277778vh] pl-[2.291667vw] mb-[3.518519vh] pr-[2.5vw]">
          <table className="w-full h-fit border-[0.130208vw] border-[#92CEC3] rounded-[0.520833vw]">
            <thead>
        ...
        {/* 3 */}
        <button className="w-[11.875vw] h-[5.462963vh] flex justify-center items-center mt-[6.018519vh] ml-[68.385417vw] text-[1.626852vh] font-semibold leading-[2.440741vh] rounded-[0.653646vw] bg-[#00A78B] text-[#FFFFFF]">
          Save
        </button>
      </article>
    </section>
