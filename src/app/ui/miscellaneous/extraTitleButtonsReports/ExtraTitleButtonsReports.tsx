...
import { ReportsButtons } from './reportsButtons/ReportsButtons';

export function ExtraTitleButtonsReports({
  filterToggle,
  reloadData,
  isFilterVisible,
  filterableFields,
  options = { moreOptionsIsVisible: true },
}: {
  filterToggle: () => void;
  ...
  return (
    <div className="ml-4 flex gap-3 justify-center items-center w-fit">
      ...
      {options.moreOptionsIsVisible && <ReportsButtons filterableFields={filterableFields} />}
    </div>
  );
}
