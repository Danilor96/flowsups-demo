...
import { AppliedFilter, FilterableField } from '@/store/customerList/types';
import { customerListStore } from '@/store/customerList/customerList.store';
import { AdvanceFilterRow } from '../extraTitleButtonsReports/reportsButtons/addReportModal/advanceFilter/advanceFilterRow/AdvanceFilterRow';
...
export const AdvancedFiltersPanel: React.FC<AdvancedFiltersPanelProps> = ({
  ...
  const addFilter = () => {
    setAppliedFilters([
      ...appliedFilters,
      { id: Date.now().toString(), field: '', condition: '', value: null },
    ]);
  };
  ...
  const handleApply = () => {
    const validFilters = appliedFilters.filter(
      (f) => f.field && f.condition && f.value !== null && f.value !== '',
    );
