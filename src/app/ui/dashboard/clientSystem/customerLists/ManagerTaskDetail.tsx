...
export function ManagerTaskDetail() {
  return (
    ...
    >
      <div className="w-[73.541667vw] h-[165.092593vh] bg-[#FFFFFF] mt-[4vh] ml-[6vw] rounded-[0.520833vw]">
        {/* header */}
        <section className="w-full h-[9.259259vh] shadow-crmFormShadow flex items-center justify-center pt-[2.037037vh] pb-[1.6vh]">
          <div className="w-[70vw] flex flex-row items-center justify-between">
        ...
        {/* content */}
        <section className="w-[67.916667vw] h-[87.222222vh] mt-[3.425926vh] ml-[2.65625vw]">
          ...
          <article className="w-full flex flex-row border-b-[0.15625vw] border-l-[0.15625vw] border-r-[0.15625vw] border-[#C9EBE6] rounded-b-[1.041667vw] pb-[4.074074vh]">
            <div className="w-[63.75vw] mx-auto mt-[3.434259vh]">
              <section className="relative flex flex-row w-full items-center justify-between gap-[7.135417vw] mb-[2.314815vh]">
                <label
                  htmlFor="clientName"
                ...
                <aside className="flex flex-row w-[51.25vw] h-[5.277778vh]">
                  <input
                    type="text"
                    name="clientName"
                    id="clientName"
              ...
              <section className="relative flex flex-row w-[63.75vw] items-center justify-between gap-[4vw] mb-[2.314815vh]">
                <article className="w-[55%] flex flex-row gap-[2.838542vw]">
                  <label
                    htmlFor="clientName"
                ...
                <article className="w-[45%] relative flex flex-row justify-between items-center">
                  <label
                  ...
                  <select
                    ...
                    id="noteReminderTime"
                    className="w-[16.590104vw] h-[5.277778vh] bg-[#F4F4F4] rounded-[0.520833vw] text-[1.666667vh] text-[#959595] font-medium leading-[1.805555vh] pl-[1.041666vw]"
                  >
              ...
              <section className="relative flex flex-row w-[63.75vw] items-center justify-between gap-[4vw] mb-[2.314815vh]">
                ...
                <article className="w-[45%] flex flex-row justify-between">
                  <label
                    htmlFor="clientName"
                    className="h-[5.277778vh] text-[1.626852vh] font-medium leading-[2.440741vh] text-[#B3B3B3] flex justify-center items-center"
                  >
                  ...
                  <aside className="flex flex-row w-[16.590104vw] h-[5.277778vh]">
                    <input
                      type="text"
                      name="clientName"
                      id="clientName"
              ...
              <section className="relative flex flex-row w-[63.75vw] items-center justify-between gap-[4vw] mb-[2.314815vh]">
                ...
                <article className="w-[45%] flex flex-row justify-between"></article>
              </section>
              <section className="relative flex flex-row w-[63.75vw] items-center justify-between gap-[4vw] mb-[2.314815vh]">
                <article className="w-[55%] flex flex-row gap-[2.838542vw]">
                  <label
              ...
              <section className="relative flex flex-row w-[63.75vw] items-center justify-between gap-[4vw]">
                <article className="w-[55%] flex flex-row gap-[2.838542vw]">
                  <label
                    htmlFor="clientName"
                    className="h-[5.277778vh] w-[12vw] text-[1.626852vh] font-medium leading-[2.440741vh] text-[#B3B3B3] flex justify-start items-center"
        ...
        {/* note section */}
        <section className="w-[67.916667vw] h-[36.481481vh] mt-[4.074074vh] ml-[2.65625vw]">
          {/* header */}
          <article className="w-full flex flex-row justify-between items-center py-[2.314815vh] px-[2.083333vw] bg-[#C9EBE6] rounded-t-[1.041667vw]">
            <p className="text-[2.777778vh] font-semibold leading-[1.805556vh] text-[#00A78B]">
              Note
          ...
          <article className="w-full flex flex-col border-b-[0.15625vw] border-l-[0.15625vw] border-r-[0.15625vw] border-[#C9EBE6] rounded-b-[1.041667vw] pb-[4.074074vh]">
            ...
            <textarea
              ...
              cols={20}
              rows={10}
              className="w-[63.90625vw] h-[19.351852vh] resize-none outline-none bg-[#F4F4F4] rounded-[0.520833vw] text-[1.666667vh] font-medium leading-[1.805556vh] text-[#959595] py-[1.388889vh] px-[0.885417vw] mx-auto mt-[1.666667vh]"
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
            className="w-[11.875vw] h-[5.462963vh] mt-[4.166667vh] ml-[56vw] flex justify-center items-center text-[1.626852vh] font-semibold leading-[2.440741vh] rounded-[0.653646vw] bg-[#00A78B] text-[#FFFFFF]"
          >
            Save
          </motion.button>
        </section>
