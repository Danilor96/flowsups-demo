...
export function ContactAttemptCustomers() {
  // ------- global states -------

  const { closeContactAttemptCustomersList } = modalWindowStore();
  ...
  // ------- computed values -------
  const contactAttemptClientsFiltered = useMemo(
        ...
        <ModalContent>
          {showFilter && (
            <CustomerListFilter
              ...
              doDataFetch={doFetch}
              specificCustomerStatusId={CustomersStatuses.Contact_Attempt}
          ...
          <ButtonContainer marginTop={1.5} block widthFull>
            <ColoredTableV2
              data={contactAttemptClientsFiltered || []}
              columns={columns}
