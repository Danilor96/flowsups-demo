...
export function SuccessNotification({
  ...
  return (
    ...
    >
      <p
        className="mx-auto flex flex-row justify-center items-center bg-[#FFF] shadow-crmFormShadow rounded-[0.520833vw]"
        style={{
      ...
      >
        ...
        <span className="w-[75%] text-[2vh] font-medium leading-[1.805556vh] text-[#00A78B]">
          {apiMessage}
        </span>
      </p>
    </motion.div>
...
export function FailNotification({
  ...
  return (
    ...
    >
      <p
        className="mx-auto flex flex-row justify-center items-center bg-[#FFF] shadow-crmFormShadow rounded-[0.520833vw] p-[0.5vw]"
        style={{
          width: `${width ? `${width}vw` : '31.197917vw'}`,
          height: `${height ? `${height}vh` : '11.296296vh'}`,
          gap: `${gap ? `${gap}vw` : '0.640625vw'}`,
      ...
      >
        ...
        <span className="w-fit text-[2vh] font-medium leading-[1.805556vh] text-[#ED0000]">
          {apiMessage}
        </span>
      </p>
    </motion.div>
...
export function ConfirmNotification({
  ...
  return (
    ...
    >
      <article
        className="relative w-fit flex flex-col gap-[2vh] rounded-[1.3vw] bg-white p-[1vw] text-[2.222222vh] text-gray-600 border-[0.15vw] border-[#00A78B]"
        style={{
      ...
      >
        ...
        <aside className="w-full flex flex-row justify-center gap-[1vw] confirmNotiBtnsContainer">
          <motion.button
            onClick={handleDecision}
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
            data-no={true}
            className="w-[8vw] px-[1vw] py-[1vh] border-[0.15vw] border-gray-500 rounded-[0.6vw] hover:bg-gray-500 hover:text-white transition-colors confirmNotiBtn"
          >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            data-yes={true}
            className="w-[8vw] text-red-600 px-[1vw] py-[1vh] border-[0.15vw] border-red-600 rounded-[0.6vw] hover:bg-red-600 hover:text-white transition-colors confirmNotiBtn"
          >
